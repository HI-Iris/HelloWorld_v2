...
public class UserRepositoryImpl implements UserRepository {
    ...
    public HttpResponse create(List<User> users, String nameToCreate) {
        ...
        switch (nameCheckResult) {
            case Default_User:
                return HttpResult.RESPONSE_DEFAULT_USER;
            case User_Exist:
                return HttpResult.RESPONSE_USER_EXIST;
            case User_Not_Exist:
                User newUser = new User(nameToCreate);
                users.add(newUser);
                return new HttpResponse(200, "User " + nameToCreate + " created");
            default:
                return HttpResult.RESPONSE_UNEXPECTED;
        }
    }
    ...
    public HttpResponse update(List<User> users, String nameToUpdate, String newName) {
        ...
        switch (nameCheckResult) {
            case Default_User:
                return HttpResult.RESPONSE_DEFAULT_USER;
            case User_Not_Exist:
                return HttpResult.RESPONSE_USER_NOT_EXIST;
            case User_Exist:
